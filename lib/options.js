...
module.exports = function (server, options) {
  ...
  _options.auth0 = {
    ...
    dialogUrl: `https://${_options.domain}/login?response_type=code&scope=${_options.scope}&client=${_options.client_id}&redirect_uri=${_options.appUrl + _options.handlerPath}`
  }
  return _options
}
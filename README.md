...
|yar|object|https://github.com/charlesread/hapi-auth-auth0/blob/master/lib/options.js|an object that is passed to [`yar`](https://github.com/hapijs/yar) (the plugin that `hapi-auth-auth0` uses for session management). See [https://github.com/charlesread/hapi-auth-auth0/blob/master/lib/options.js](https://github.com/charlesread/hapi-auth-auth0/blob/master/lib/options.js) for defaults.  Be careful.|